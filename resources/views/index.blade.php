              ...
              {{-- <div class="row">
                <div class="col-md-6 form-group">
                  ...
                  <select name="last_education" id="">
                    <option value="SMK">SMK</option>
                    <option value="SMA">SMA</option>
                    <option value="Universitas">UNIV</option>

                </select>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="education_name" id="education_name" placeholder="Education Intitution" required>
                </div>
              </div> --}}
